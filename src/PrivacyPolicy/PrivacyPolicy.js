                ...
                <main>
                    ...
                    <section className="section inner-page">
                        <Container className="">
                            ...
                            <div className='mb-4 mb-md-5 policy-page'>
                                <h1 className="title page-title">Privacy Policy</h1>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to URDU IT Academy.</p>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <p><strong>Website</strong> refers to URDU IT Academy, accessible from <a href="http://urduitacademy.com" rel="external nofollow noopener" target="_blank">http://urduitacademy.com</a></p>
                                        </li>
                                        <li>
                                    ...
                                    For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page: <a href="https://policies.google.com/privacy
" target="_blank">https://policies.google.com/privacy</a>
                                    ...
                                    <ul>
                                        <li>By email: admin@urduitacademy.com</li>
                                    </ul>
                                {/* </div> */}
